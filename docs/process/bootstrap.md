...
- whether the default `jj` and `bd` assumptions should remain
...
5. Keep process docs generic unless the project has clearly chosen a different
   workflow.
6. Delete or rewrite template placeholders once real project content exists.
